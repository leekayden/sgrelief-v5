        ...
        <div class="col-md-9">
          ...
          <div class="container" style="padding-left:50px; padding-top:50px; padding-bottom:50px;">
            ...
            ?>
                ...
                <h3 style="font-family: 'Caveat'; color: #f2cc8f; padding-left:4px;">Jobs available: <?php echo $numberofposts; ?> </h3>
            <?php }
            } ?>
            ...
            ?>
                ...
                <h3 style="font-family: 'Caveat'; color: #f2cc8f; padding-left:4px;"> Active Users: <?php echo $numberofusers; ?> </h3>
            <?php }
            } ?>
            <!--------------------------------------------------------------------------------------------->
