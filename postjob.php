                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <p>Don't enter the school name, location or any contacts here.</p>
                            </div>

                            <div class="form-group">
                                <label for="category">Cluster</label>
                                <select type="text" name="category" class="form-control" style="border-radius:0px; height: 50px;" placeholder="Cluster"> <?php include 'categoryOptions.php'; ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="desc">Job requirements/prerequisites</label>
