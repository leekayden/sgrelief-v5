      ...
      <div class="modal-body">
        ...
        <div id="cd-login">
          <form class="cd-form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            ...
            <p class="fieldset">
              <label class="image-replace cd-email" for="eemail">Email</label>
              <input class="full-width has-padding has-border" id="email" name="email" type="email" placeholder="Email">
